...
def insertBLOB():
    ...
    try:
        ...
        data_tuple = (fname, addr,email,mobile,gender,time,empPhoto,carno1,cnpwd)
...
l9 = tk.Label(window, text="Car Number Plate No. :", width=12, font=("Times new roman", 15, "bold"), bg="snow")
l9.place(x=130, y=500)
t9 = tk.Entry(window, textvar=carno, width=20, font=('', 15))
t9.place(x=330, y=500)

l10 = tk.Label(window, text="Chassis No.:", width=13, font=("Times new roman", 15, "bold"), bg="snow")
l10.place(x=130, y=550)

t10 = tk.Entry(window, textvar=chassis, width=20, font=('', 15))
